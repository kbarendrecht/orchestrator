...
`remote.pushDefault`. Stack: PHP (`acme\`) + Angular + Playwright, dockerized.
  ...
  "reviews": [
    {
      ...
      "url": "https://github.com/acme/acme/pull/2001",
      "author": "erin",
...
Host `<main>/.claude/worktrees/<name>` ↔ container `/acme/.claude/worktrees/<name>`.
